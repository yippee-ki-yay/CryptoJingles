...
describe('Wrapped Jingle', () => {
  ...
  before(async () => {
    const WrappedJingle = await ethers.getContractFactory('WrappedJingle');
  ...
  it('Should wrap and existing jingle from V1', async () => {
    // simulate account
  ...
  it('Should unwrap and existing jingle from V1', async () => {
    ...
    expect(numWrappedTokens.toString()).to.be.eq('0');
  });

  it('Should wrap and existing jingle from V0', async () => {
