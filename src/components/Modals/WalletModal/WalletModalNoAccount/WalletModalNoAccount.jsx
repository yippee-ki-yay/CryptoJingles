...
const WalletModalNoAccount = ({
  ...
  <div className="wallet-modal-no-account-wrapper">
    <ModalBody closeModal={closeModal} title="wallet_modal.not_connected">

      <ConnectWalletButtons />

      <div className="new-to-eth">
        {/* {trans('modal.new_to_eth', */}
        {/*  { link: (chunk) => (<a href="https://ethereum.org/en/wallets/" className="link" target="_blank" rel="noopener noreferrer">{chunk}</a>) })} */}
      </div>
